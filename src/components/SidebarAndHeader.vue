              ...
              >
                <div class="absolute left-full top-0 flex w-16 justify-center pt-5">
                  <button type="button" class="-m-2.5 p-2.5" @click="sidebarOpen = false">
                    ...
                    <XMarkIcon class="size-7 text-white" aria-hidden="true" />
                  </button>
                </div>
              </TransitionChild>
            ...
            <Menu as="div" class="relative">
              <MenuButton class="-m-1.5 flex items-center p-1.5">
                ...
                <img
                  ...
                  src="file:///C:/Users/tibor/Downloads/WhatsApp%20Image%202024-12-10%20at%203.37.18%20PM.webp"
                  alt=""
                />
...
import { Bars3Icon, HomeIcon, XMarkIcon, HomeModernIcon } from '@heroicons/vue/24/outline'
...
const navigation = ref([
  ...
  { name: 'Point of interest', href: '/poi', icon: HomeModernIcon, current: false },
])
